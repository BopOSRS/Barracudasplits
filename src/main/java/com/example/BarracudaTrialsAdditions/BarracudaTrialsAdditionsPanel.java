...
public class BarracudaTrialsAdditionsPanel extends PluginPanel
{
    ...
    public BarracudaTrialsAdditionsPanel()
    {
     ...
     */
    public void updateData(List<BarracudaTrialsAdditionsPlugin.RunRecord> runs, int personalBestTicks)
    {
        // PB label
        ...
        else
        {
            ...
            {
                BarracudaTrialsAdditionsPlugin.RunRecord r = runs.get(i);
    ...
    {
        private final BarracudaTrialsAdditionsPlugin.RunRecord record;
        private final JPanel header = new JPanel(new BorderLayout());
        private final JPanel splitsPanel = new JPanel();
        private boolean expanded = false;

        RunPanel(BarracudaTrialsAdditionsPlugin.RunRecord record)
        {
            this.record = record;
